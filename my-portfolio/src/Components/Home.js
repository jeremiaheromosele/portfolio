...
const Home = () => {
  return (
    <section name='home' className='h-full  w-full bg-gradient-to-b from-black via-black to-gray-800'>
        ...
        <div className='flex flex-col justify-center'>
          ...
          <div className='mb-20'>
            <Link to='portfolio'smooth duration={500} className='group text-white w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-cyan-500 to-blue-500 cursor-pointer'>
              portfolio <span className='group-hover:rotate-90 duration-500'><PiArrowRight size={25} className='ml-1'/></span>
            </Link>
          </div>
        </div>
      </div>
